...
@Entity
@Table(name = "ordermonthstatistics")
public class OrderMonthStatistics  extends Bean {
	@Column(name="year", length=4)
	@Valid(varType = VarType.Number, minValue = 0, maxValue = 9999D)
	private String year;
	@Column(name="month", length=2)
	@Valid(varType = VarType.Number, minValue = 0, maxValue = 99D)
	...
	public OrderMonthStatistics() {
		super();
	}
	public OrderMonthStatistics(Long corporationsid, String year, String month, Long objectsid, Integer objecttype) {
		super();
