...
@Entity
@Table(name = "warnmonthstatistics")
public class WarnMonthStatistics  extends Bean {
	...
	public WarnMonthStatistics() {
		super();
	}

	public WarnMonthStatistics(Long corporationsid, String year, String month, Long objectsid, Integer objecttype) {
		super();
